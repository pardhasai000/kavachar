      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <div className="text-center relative z-10">
            ...
            <h4 className="text-xs uppercase tracking-[0.25em] font-sans font-bold text-amber-950/80">
              {t.certTitle}
            </h4>
            ...
            <div className="w-48 h-0.5 bg-gradient-to-r from-transparent via-amber-900 to-transparent mx-auto mt-3"></div>
          </div>
